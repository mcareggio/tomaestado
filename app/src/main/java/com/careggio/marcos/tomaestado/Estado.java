...
public class Estado {
    ...
    public File exportarEstadosAmbosServicios(Context context,String periodo){
        ...
        try {
            ...
            //outputStream = context.openFileOutput("prueba_export.txt", Context.MODE_PRIVATE);
            string="Ruta;Folio;Nombre y Apellido;Direccion;Estado Energia "+Calculo.getPeriodoAnterior(periodo)+";Estado Energia "+periodo+";Consumo Energia;Observacion;Obsevacion Sistema;Estado Agua "+Calculo.getPeriodoAnterior(periodo)+";Estado Agua "+periodo+";Consumo Agua;Observacion;Obsevacion Sistema;Geolocalizacion\n";
            ...
            for(i=0;i<array.length;i++) {
                ...
                string=array[i][0]+";"+array[i][1]+";"+array[i][2]+";"+array[i][3]+";"+array[i][4]+";"+array[i][5]+";"+consumo_str+";"+array[i][6]+";"+array[i][7]+";"+array[i][9]+";"+array[i][10]+";"+consumo2_str+";"+array[i][11]+";"+array[i][12]+";"+array[i][14]+"\n";
                System.out.println(string);
